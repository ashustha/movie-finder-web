...
const AddMovies= () => {
    ...
    const [formData, setFormData] = useState({
      ...
      useEffect(() => {
        // Fetch options for directors, writers, and stars
        const fetchOptions = async () => {
            try {
                const [directorsRes, writersRes, starsRes,genresRes] = await Promise.all([
                ...
                const [directorsData, writersData, starsData,genresData] = await Promise.all([
                    directorsRes.json(),
                    writersRes.json(),
                    starsRes.json(),
                    genresRes.json(),
      ...
      const handleMultiSelectChange = (e: React.ChangeEvent<HTMLSelectElement>, type: 'writer_ids' | 'star_ids' | 'genre_ids') => {
